...
use App\Http\Controllers\ApartadoEquipoController;
...
Route::group(['middleware' => 'auth'], function () {
    ...
    */
    ...
    Route::group(['prefix' => 'apartado'], function () {
        // Main reservation form
        Route::get('/', [ApartadoEquipoController::class, 'index'])->name('apartado.index');

        // Search models by company
        Route::get('/search-models', [ApartadoEquipoController::class, 'searchModels'])->name('apartado.search-models');

        // Get model quantity
        Route::get('/model-quantity', [ApartadoEquipoController::class, 'getModelQuantity'])->name('apartado.model-quantity');

        // Submit reservation request
        Route::post('/submit', [ApartadoEquipoController::class, 'submit'])->name('apartado.submit');
    });
